...
Presentation attached as a PDF, describing problem and model performance in further detail.

Food Loss and Waste Database | Technical Platform on the Measurement and Reduction of Food Loss and Waste 
